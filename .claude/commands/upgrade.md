# Ideate improvements based on upgraded packages

The packages we're using may have changed.

Look at the git history to see which packages changed (if any) and recommend some improvements to take advantage of
