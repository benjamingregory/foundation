...
First, you will be given a feature description and (optionally) a repository URL — if none is given, use the current repository. Here they are:
...
- If this repo has a PRD template directory (e.g. `templates/prd`, `docs/templates/`), check it for additional sections to include for any user-facing feature.
